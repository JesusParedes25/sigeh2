...
<div class="site-cover2 site-cover2-sm same-height overlay single-page" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('../../images/desempeño2.jpg') no-repeat center; background-size: cover; cursor: default;">
  ...
  <section class="section">
    <div class="container">
      <h2 style="color: #691c32;">Medio Ambiente</h2>
      <hr>
      <iframe title="Indicadores agropecuarios" width=100% height="541.25" src="https://app.powerbi.com/view?r=eyJrIjoiMTdjNmZiN2YtMWYyZC00N2UzLWE0Y2MtMDE3MDNjN2NhNzdmIiwidCI6ImZjMzM0YjI2LWI1NzgtNGJlYi1hYmJhLWJmNDMzNTBlOThjMCJ9" frameborder="0" allowFullScreen="true"></iframe>
